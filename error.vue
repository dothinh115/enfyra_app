<template>
  ...
  >
    <div class="text-center space-y-6 px-4">
      ...
      <div class="sr-only">
        <a href="#error-actions" class="focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:bg-primary focus:text-white focus:px-4 focus:py-2 focus:rounded">
