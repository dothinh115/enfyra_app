...
<template>
  <div class="rich-text-editor">
    <!-- Loading State -->
    <div v-if="isLoading" class="flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700">
    ...
    <!-- Error State -->
    <div v-else-if="isError" class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
      <div class="flex">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium text-red-800 dark:text-red-300">Rich text editor failed to load</h3>
          <p class="text-sm text-red-700 dark:text-red-400 mt-1">Please refresh the page to try again.</p>
        </div>
      </div>
    </div>
